...
class Operaciones():
    ...
    def agregarEquipo(self):
        ...
        while cond == "si":
            ...
            self.listaSinReparar.append(equip)                     #terminar opcion de seguir cargando con validacion
    ...
    def grabarListas(self):
        ...
        for equi in self.listaSinReparar:
            archivo.write(equi.marca + "&" + equi.modelo + "&" + equi.dueno + "&" + equi.problema)
        archivo.close

        archivo = open ("equipoReparado.txt","w")
        for equi in self.listaReparados:
            archivo.write(equi.marca + "&" + equi.modelo + "&" + equi.dueno + "&" + equi.problema + "&" + equi.precio + "&" + equi.fecha)
        archivo.close
